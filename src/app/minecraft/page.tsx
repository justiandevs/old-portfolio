  ...
  return (
    <>
      ...
      <section className="content">
        ...
        <p className="mt-6">So do you feel like playing vanilla minecraft occasionally for an evening with a friendly community around you? Then I would recommend contacting me through my <a href="/" target="_blank">discord server</a> to get access to the whitelist.</p>
        <hr className="my-8" />
        <h2>Ip address</h2>
